...
class TestEndToEndProcessing(unittest.TestCase):
    ...
    def test_multiple_file_processing(self):
        ...
        with patch('builtins.input', side_effect=['2', '2', '2']):  # Always choose counter
        ...
        self.assertEqual(counters, list(range(1, len(counters) + 1)))  # Sequential counters
...
class TestCommandLineInterface(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.script_path = Path(__file__).parent.parent / "src" / "texterify_processor.py"
    ...
    def test_help_argument(self):
        ...
        self.assertTrue("usage:" in combined_output.lower(), f"Expected 'usage:' in output: {repr(combined_output)}")
        self.assertTrue("texterify" in combined_output.lower(), f"Expected 'texterify' in output: {repr(combined_output)}")
