...
class ArchiveService:
    ...
    @staticmethod
    def create_archive(source_dir: Path, output_path: Path, compression_level: int = 6) -> bool:
    ...
    @staticmethod
    def _identify_language_files(file_list: List[str], config: ProcessingConfig) -> List[str]:
